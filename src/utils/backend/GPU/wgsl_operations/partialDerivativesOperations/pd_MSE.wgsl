fn pd_MSE(gId : vec3u, t : u32, currParent : u32){
    ...
    ping.entries[currPd_parentTrue + index] = f32(2) * ( ping.entries[parentPred_dataFirstIndex + index] - ping.entries[parentTrue_dataFirstIndex + index] );
    ping.entries[currPd_parentPred + index] = f32(2) * ( ping.entries[parentPred_dataFirstIndex + index] - ping.entries[parentTrue_dataFirstIndex + index] );
}